...
public class HibernateEntityHelper {
    ...
    /**
     * Partition a general input ID list based on {@link #MAX_PARAMETER_COUNT}, then execute the requested queries with the partitioned ID lists using
     * function f.
     *
     * @param ids
     *            a {@link java.util.Collection} object.
     * @param function
     *            Callable function {@link hu.icellmobilsoft.coffee.se.function.BaseExceptionFunction} object.
     * @param <T>
     *            a T object.
    ...
    /**
     * Partition a general input ID list based on MAX_PARAMETER_COUNT, then execute the requested queries using the partitioned ID lists and param1
     * with function f.
     *
     * @param <T>
     *            T object
    ...
    /**
     * Partition a general input ID list based on MAX_PARAMETER_COUNT. Execute the requested queries using the partitioned ID lists, param1, and
     * param2 with function f.
     *
     * @param <T>
     *            a T object.
     * @param <P1>
