...
public class HibernateJpaUtil {
    ...
    public static String toNativeSQLNoEx(EntityManager em, Query query) {
        try {
            ...
            Logger.getLogger(HibernateJpaUtil.class).warn("Exception on converting Query to native SQL!", e);
        }
        return null;
    }
        ...
        if (query instanceof SqmInterpretationsKey.InterpretationsKeySource && query instanceof QuerySqmImpl) {
            ...
            Supplier buildSelectQueryPlan = () -> {
                try {
                    ...
                    Logger.getLogger(HibernateJpaUtil.class).warn("Exception on calling buildSelectQueryPlan()!", e);
                    return null;
                }
            };
