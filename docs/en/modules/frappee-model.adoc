...
The variable: `FRAPPEE_MODEL_BASE_JAVA_TIME_TIMEZONE_ID`
...
service:
    environment:
        FRAPPEE_MODEL_BASE_JAVA_TIME_TIMEZONE_ID: Europe/Budapest
----

.Command line
[sorce,text]
----
java -Dfrappee.model.base.java.time.timezone.id=Europe/Budapest
----

.java code
[sorce,java]
----
System.setProperty("frappee.model.base.java.time.timezone.id","Europe/Budapest");
----
